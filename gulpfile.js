...
gulp.task('scss', function () {
  return gulp.src([paths.src.scss + '/custom/**/*.scss', paths.src.scss + '/theme/**/*.scss', paths.src.scss + '/main.scss'])
    .pipe(wait(500))
...
gulp.task('serve', gulp.series('scss', 'html', 'index', 'assets', 'vendor', function () {
  ...
  gulp.watch([paths.src.scss + '/custom/**/*.scss', paths.src.scss + '/theme/**/*.scss', paths.src.scss + '/main.scss'], gulp.series('scss'));
